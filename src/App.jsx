    ...
    <div style={{background:"linear-gradient(135deg,#0f172a 0%,#1e1b4b 100%)",borderBottom:"1px solid #1e293b",padding:"0 20px",position:"sticky",top:0,zIndex:50,boxShadow:"0 4px 24px rgba(0,0,0,0.45)"}}>
      <div style={{display:"flex",alignItems:"center",gap:12,height:54,flexWrap:"wrap"}}>
        ...
        <div style={{display:"flex",gap:2,flex:1}}>
          {TABS.map(t=>(<button key={t.key} onClick={()=>setTab(t.key)} style={{padding:"5px 12px",borderRadius:8,border:"none",background:tab===t.key?"#6366F1":"transparent",color:tab===t.key?"#fff":"#64748B",cursor:"pointer",fontSize:12,fontWeight:tab===t.key?700:400,fontFamily:"'Noto Sans SC',sans-serif",whiteSpace:"nowrap"}} dangerouslySetInnerHTML={{__html:t.l}}/>))}
        </div>
